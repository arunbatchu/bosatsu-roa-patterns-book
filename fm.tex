...
\def\TITLE{Resource-Oriented Architecture Patterns}
\def\AUTHOR{Brian Sletten}
\def\AFFILIATION{Bosatsu Consulting, Inc.}
\def\LECTURE{\ \#1}
\def\lcSYNTHESIS{Synthesis Lectures on Semantic Web}
\def\SYNTHESIS{\uppercase{Synthesis Lectures on Semantic Web}}
